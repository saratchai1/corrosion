    ...
    <Suspense fallback={<ViewLoading label="กำลังเปิดแผนที่ดาวเทียม…" />}>
      <main className="app-shell">
        <aside className="sidebar">
          ...
          {selection
            ? <TransectChart selection={selection} />
            : <section className="empty-chart"><span>03</span><p>คลิกแนว transect บนแผนที่เพื่อดูกราฟตำแหน่งขอบเขตตามเวลา</p><small>Click a transect for its time series.</small></section>}
