...
def main() -> None:
    ...
    parser.add_argument("--sensor", choices=SENSOR_CAL, required=True)
    ...
    cal = SENSOR_CAL[args.sensor]
    g_scale = cal["scale"] if args.green_scale is None else args.green_scale
    g_offset = cal["offset"] if args.green_offset is None else args.green_offset
    s_scale = cal["scale"] if args.swir_scale is None else args.swir_scale
    s_offset = cal["offset"] if args.swir_offset is None else args.swir_offset
