...
- Git LFS 3.8.0 is installed and tracking rules are present, but no authenticated upload/quota confirmation is available. Therefore **no raster binaries are pushed**; local rasters are recorded in manifests/checksums.
