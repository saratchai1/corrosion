...
6. Visually inspect at least one image per sensor and decade/time block; for Sentinel-1 confirm the GCP-warped image shows coherent geography rather than scan-line ramps.
