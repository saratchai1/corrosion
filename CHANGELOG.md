...
- Added reproducible STAC cataloging/download helper, compositing, validation and preview scripts.
- Added catalog schemas, manifest/checksum placeholders and data-source/limitation/reproduction docs.
- Prepared Git LFS tracking rules; no raster binaries pushed pending local `git lfs env` and no-cost quota verification.
